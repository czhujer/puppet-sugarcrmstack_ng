...
class sugarcrmstack_ng (
  ...
  $apache_php_apache_php_cache_engine = $::sugarcrmstack_ng::params::apache_php_php_cache_engine,
  $apache_php_apache_php_session_save_handler = $::sugarcrmstack_ng::params::apache_php_php_session_save_handler,
  $apache_php_apache_php_session_save_path = $::sugarcrmstack_ng::params::apache_php_php_session_save_path,
  $apache_php_apache_apache_manage_user = $::sugarcrmstack_ng::params::apache_php_apache_manage_user,
